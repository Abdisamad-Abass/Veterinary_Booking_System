      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 min-h-[300px]">
          <div className="sm:w-[280px] w-full">
            <img
              className="object-cover w-full h-full rounded-lg bg-primary"
              src={docInfo.image}
              alt=""
            />
          </div>
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 flex flex-col justify-between sm:min-h-[300px]">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1 text-sm text-gray-600">
                ...
                <button className="px-3 py-1 text-xs text-white bg-blue-600 rounded-full">
                  {docInfo.experience}
                </button>
              </div>
              <div>
        ...
        <div className="mt-4 font-medium text-gray-700 sm:ml-72 sm:pl-4">
          ...
          <div className="flex items-center w-full gap-3 pr-2 mt-4 overflow-x-scroll max-h-64 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
            {docSlots.length &&
