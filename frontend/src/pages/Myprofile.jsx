  ...
  return (
    userData && (
      <div className="flex flex-col max-w-lg gap-2 text-sm">
        ...
        {isEdit ? (
          <input
            className="px-3 mt-4 text-3xl font-medium border border-gray-300 rounded bg-gray-50 max-w-72"
            type="text"
            value={userData.name}
            onChange={(e) =>
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {isEdit ? (
              <input
                className="px-3 bg-gray-100 border border-gray-300 rounded max-w-36"
                type="text"
            ...
            {isEdit ? (
              <p>
                <input
                  className="px-3 border border-gray-300 rounded bg-gray-50 max-w-36"
                  onChange={(e) =>
                    setUserData((prev) => ({
                      ...prev,
                ...
                <br />
                <input
                  className="px-3 mt-1 border border-gray-300 rounded bg-gray-50 max-w-36"
                  onChange={(e) =>
                    setUserData((prev) => ({
                      ...prev,
        ...
        <div>
          ...
          <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
            ...
            {isEdit ? (
              <select
                className="bg-gray-100 border border-gray-300 rounded max-w-20"
                onChange={(e) =>
